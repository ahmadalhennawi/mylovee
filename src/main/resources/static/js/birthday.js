...
function startFinalSequence(finishingAge) {
  ...
  try {
    ...
    const seq = [
      ...
      'الكون كلو يدوّر، وانا في عيونك انتي يا لموش شارد 💜',
      ' لمووووووش',
    ...
    btn.addEventListener('click', () => {
      ...
      if (clicks >= 3) {
        ...
        if (msgEl) {
          ...
          secret.textContent = ' نحبك لاخر العمر يا لموووووشتي بتمنى يكون العرض عجبك و تكوني بهي اللحظه راضيه عني. 🥰';
